...
export class Convert {
    public static toTickerFull(json: string): TickerFull[] {
        return cast(JSON.parse(json), a(r("TickerFull")));
    }

    public static tickerFullToJson(value: TickerFull[]): string {
...
const typeMap: any = {
    "TickerFull": o([
        ...
        { json: "exchange_timestamp", js: "exchangeTimestamp", typ: u(undefined, "") },
        { json: "instrument_token", js: "instrumentToken", typ: u(undefined, 0) },
        { json: "last_price", js: "lastPrice", typ: u(undefined, 0) },
        { json: "last_trade_time", js: "lastTradeTime", typ: u(undefined, "") },
