...
//
//   let marginCommodity = try MarginCommodity(json)

//
// To read values from URLs:
//
//   let task = URLSession.shared.marginCommodityTask(with: url) { marginCommodity, response, error in
//     if let marginCommodity = marginCommodity {
//       ...
//     }
//   }
//   task.resume()
...
//
//   Alamofire.request(url).responseMarginCommodity { response in
//     if let marginCommodity = response.result.value {
//       ...
//     }
//   }
...
// MARK: - MarginCommodity
struct MarginCommodity: Codable {
    let data: DataClass?
    let status: String?
}

// MARK: MarginCommodity convenience initializers and mutators

extension MarginCommodity {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(MarginCommodity.self, from: data)
    }
...
extension URLSession {
    ...
    func marginCommodityTask(with url: URL, completionHandler: @escaping (MarginCommodity?, URLResponse?, Error?) -> Void) -> URLSessionDataTask {
...
extension DataRequest {
    ...
    @discardableResult
    func responseMarginCommodity(queue: DispatchQueue? = nil, completionHandler: @escaping (DataResponse<MarginCommodity>) -> Void) -> Self {
