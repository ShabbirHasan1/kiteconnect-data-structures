...
public class Data {
    ...
    @JsonProperty("fund_source")
    public void setFundSource(String value) { this.fundSource = value; }
    ...
    public Object getSIPRegNum() { return sipRegNum; }
    @JsonProperty("sip_reg_num")
    public void setSIPRegNum(Object value) { this.sipRegNum = value; }
    ...
    @JsonProperty("step_up")
    public void setStepUp(StepUp value) { this.stepUp = value; }
