...
class Datum {
    ...
    float|mixed  lower_circuit_limit; // json: "lower_circuit_limit"
    int|mixed    net_change;          // json: "net_change"
    ...
    float|mixed  upper_circuit_limit; // json: "upper_circuit_limit"
