...
#   puts margins.data&.equity&.utilised&["…"]
#
...
class DataClass < Dry::Struct
  attribute :commodity, Ity.optional
  attribute :equity,    Ity.optional

  def self.from_dynamic!(d)
    d = Types::Hash[d]
    new(
      commodity: d["commodity"] ? Ity.from_dynamic!(d["commodity"]) : nil,
      equity:    d["equity"] ? Ity.from_dynamic!(d["equity"]) : nil,
    )
  end
